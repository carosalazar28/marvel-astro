...
**Resultado:** el progreso permanece disponible al recargar en el mismo navegador. El tracker ofrece reinicio, elimina todos los estados locales y vuelve a `Sin ver` sin eliminar ni ocultar la ruta editorial.
