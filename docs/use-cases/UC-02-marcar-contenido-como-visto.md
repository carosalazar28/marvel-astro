...
**Resultado:** el progreso permanece disponible al recargar en el mismo navegador. El tracker ofrece reinicio, elimina todos los estados locales y vuelve al estado editorial definido en el JSON —incluidas las películas marcadas inicialmente como `Vista`— sin eliminar ni ocultar la ruta editorial.
